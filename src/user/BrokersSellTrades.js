...
import ExportToExcel from "./ExportToExcelBrokersSellTrades";
import { isAuthenticated } from "../auth";
import { brokersSellTrades } from "../core/Apicore";

const BrokersSellTrade = () => {
  ...
  const loadBrokerSellTrades = () => {
    brokersSellTrades(code).then(data => {
      if (data.error) {
        setError(data.error);
      } else {
        setTrades(data);
...
export default BrokersSellTrade;
