  ...
  return (
    <div>
      ...
      <div
        ...
        className="border-right border-secondary-light shadow-none"
      >
        ...
        <ul className="sidebar-menu do-nicescrol">
          ...
          <li>
            <Link to="/user/inbox" className="waves-effect">
              <i className="fa fa-inbox mr-2 text-aqua"></i> <span>Inbox</span>
            </Link>
          </li>

          <li>
            <Link to="/user/securities" className="waves-effect">
              <i className="icon-home"></i> <span>Securities</span>{' '}
              <i className="fa fa-angle-left pull-right"></i>
            </Link>
          </li>
          <li>
            <Link to="/user/securities/performance" className="waves-effect">
              <i className="fa fa-inbox mr-2 text-aqua"></i>{' '}
              <span>Securities Performace</span>
            </Link>
          </li>

          <li>
            <Link to="/user/equity" className="waves-effect">
              <i className="icon-home"></i> <span>Equity Report</span>{' '}
              <i className="fa fa-angle-left pull-right"></i>
            </Link>
          </li>
          <li>
            <Link to="/user/equity/priceList" className="waves-effect">
              <i className="fa fa-inbox mr-2 text-aqua"></i>{' '}
              <span>Official Price List</span>
            </Link>
          </li>
          <li>
            <Link to="/user/equity/monthly" className="waves-effect">
              <i className="fa fa-inbox mr-2 text-aqua"></i>{' '}
          ...
          <li>
            <Link to="/user/brokers" className="waves-effect">
              <i className="icon-home"></i> <span>Brokers</span>{' '}
              <i className="fa fa-angle-left pull-right"></i>
            </Link>
          </li>
          ...
          <li>
            <Link to="/user/annualreports" className="waves-effect">
              <i className="icon-home"></i> <span>Reports</span>{' '}
              <i className="fa fa-angle-left pull-right"></i>
            </Link>
          </li>
          ...
          <li>
            <Link to="/user/corporate" className="waves-effect">
              <i className="icon-home"></i> <span>Corporate Action</span>{' '}
              <i className="fa fa-angle-left pull-right"></i>
            </Link>
          </li>
          <li>
            <Link to="/user/bonds" className="waves-effect">
              <i className="icon-home"></i> <span>Bonds</span>{' '}
              <i className="fa fa-angle-left pull-right"></i>
            </Link>
          </li>
          ...
          <li>
            <Link to={`/user/profile/${_id}`} className="waves-effect">
              <i className="fa fa-circle-o text-aqua"></i> <span>Profile</span>
            </Link>
          </li>
        </ul>
      </div>
          ...
          <ul className="navbar-nav align-items-center right-nav-link">
            <li className="nav-item dropdown-lg">
              ...
              >
                ...
                <span className="badge badge-danger badge-up">1</span>
              </Link>
            ...
            <li className="nav-item dropdown-lg">
              ...
              >
                ...
                <span className="badge badge-primary badge-up">1</span>
              </Link>
              <div className="dropdown-menu dropdown-menu-right">
                <ul className="list-group list-group-flush">
                  <li className="list-group-item d-flex justify-content-between align-items-center">
            ...
            <li className="nav-item">
              ...
              >
                <span className="user-profile">
                  <img
                    src="https://catholic-foundation.org/wp-content/uploads/2017/07/unisex-avatar.png"
